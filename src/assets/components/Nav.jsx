...
const Nav = () => {
  ...
  const isRentActive =
    location.pathname === "/rentservice" || location.pathname === "/rentlisting";
      ...
      <nav className="navbar">
        ...
        <div className={`navx ${menuOpen ? "show" : ""}`}>
          <ul className={`nav-links ${menuOpen ? "show" : ""}`}>
            <li>
              <Link to="/" style={{ color: isHomeActive ? activeColor : defaultColor }}>
                Home
              </Link>
            </li>
            <li>
              <Link to="/rentservice" style={{ color: isRentActive ? activeColor : defaultColor }}>
                RentPcs
              </Link>
            </li>
            <li className="dropdown">
              <Link to="/ourproducts" style={{ color: isOurProductsActive ? activeColor : defaultColor }}>
                OurProducts <i className="bx bx-chevron-down"></i>
              </Link>
              <ul className="dropdown-menu">
                <li>
                  <Link to="/computerlisting" style={{ color: isComputerActive ? activeColor : defaultColor }}>
                    Computers
                  </Link>
                </li>
                <li>
                  <Link to="/monitorlisting" style={{ color: isMonitorActive ? activeColor : defaultColor }}>
                    Monitors
                  </Link>
                </li>
                <li>
                  <Link to="/accessorylisting" style={{ color: isAccessoryActive ? activeColor : defaultColor }}>
                    Accessories
                  </Link>
                </li>
              </ul>
